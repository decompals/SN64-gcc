...
MAYBE_TARGET_DEFAULT = -DTARGET_CPU_DEFAULT=16
...
target=mips-mips-gnu
target_alias="Nintendo 64"
xmake_file=../Makefile.in
tmake_file=./config/t-libc-ok
out_file=./config/mips/mips.c
out_object_file=mips.o
md_file=./config/mips/mips.md
tm_file=./config/mips/n64.h
build_xm_file=./config/i386/xm-gnu.h
host_xm_file=./config/i386/xm-gnu.h
